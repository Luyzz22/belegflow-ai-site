    ...
    <div className="min-h-screen bg-[#0a0a0a] text-[#fafafa]">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 pt-[72px]">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#e85d04]/10 border border-[#e85d04]/20 rounded-full text-sm text-[#f48c06] font-medium mb-8">
          <span className="w-2 h-2 bg-[#e85d04] rounded-full animate-pulse" /> E-Rechnungspflicht ab Januar 2027
        </div>
        ...
        <p className="text-[clamp(1rem,2vw,1.25rem)] text-[#a3a3a3] max-w-[600px] mb-12 font-light">
          BelegFlow AI erkennt, kontiert und exportiert Ihre Eingangsrechnungen mit KI — GoBD-konform, DATEV-ready, in unter 3 Sekunden.
        </p>
        ...
        <div className="flex items-center gap-8 flex-wrap justify-center">
          {[["<3s", "Pro Rechnung"], ["99%", "Genauigkeit"], ["DATEV", "Nativer Export"], ["100%", "GoBD-konform"]].map(([v, l], i) => (
        ...
        <div className="max-w-[1100px] mx-auto bg-[#e85d04]/[0.06] border border-[#e85d04]/15 rounded-[20px] p-12 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            ...
            <p className="text-[#a3a3a3] text-[15px] max-w-[560px] leading-relaxed">
              Ab Januar 2027 müssen alle B2B-Unternehmen in Deutschland E-Rechnungen im XRechnung- oder ZUGFeRD-Format empfangen und verarbeiten können.
            </p>
          </div>
      ...
      <section id="features" className="px-6 py-24 bg-[#0f0f0f]">
        <div className="max-w-[1100px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/[0.06] rounded-[20px] overflow-hidden">
            {[
              ["🤖", "KI-Erkennung", "Gemini 2.0 Flash + Claude extrahieren Betr\u00e4ge, Lieferanten und Steuers\u00e4tze."],
              ["📊", "Auto-Kontierung", "SKR03/04 automatisch vorgeschlagen — 90%+ Konfidenz."],
              ["📤", "DATEV-Export", "Nativer Export mit Steuercode-Mapping und Belegbild."],
              ["✅", "Freigabe-Workflow", "Mehrstufige Genehmigung mit Audit Trail."],
              ["📧", "E-Mail Ingestion", "Rechnungen per E-Mail — automatische Verarbeitung."],
              ["🔒", "GoBD & Compliance", "SHA-256 Hash-Chain, KoSIT-Validierung."],
      ...
      <section id="ablauf" className="px-6 py-24">
        <div className="max-w-[1000px] mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[["1", "Hochladen", "PDF, E-Mail oder XRechnung"], ["2", "KI analysiert", "Daten in <3 Sekunden extrahiert"], ["3", "Freigeben", "Prüfen und genehmigen"], ["4", "Exportieren", "DATEV, Lexoffice, sevDesk"]].map(([n, t, d]) => (
      ...
      <section id="preise" className="px-6 py-24">
        <div className="max-w-[1000px] mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/[0.06] rounded-[20px] overflow-hidden">
            {[
              { tier: "Starter", price: "€0", sub: "50 Belege/Monat", features: ["50 Rechnungen/Monat", "KI-Erkennung", "DATEV CSV-Export", "1 Benutzer"], featured: false },
              { tier: "Professional", price: "€149", sub: "500 Belege/Monat", features: ["500 Rechnungen/Monat", "Gemini + Claude", "Nativer DATEV-Export", "Freigabe-Workflows", "Finance Copilot", "5 Benutzer"], featured: true },
