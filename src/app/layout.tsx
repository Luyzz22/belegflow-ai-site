...
export const metadata: Metadata = {
  ...
  description: "BelegFlow AI automatisiert Ihren Rechnungseingang mit KI. GoBD-konform, DATEV-ready, bereit für die E-Rechnungspflicht 2027. Kostenlos starten.",
  ...
  openGraph: {
    ...
    description: "KI-gestützte Rechnungsverarbeitung. GoBD-konform, DATEV-ready, in unter 3 Sekunden.",
