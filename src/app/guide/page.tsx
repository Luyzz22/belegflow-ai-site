...
export const metadata: Metadata = {
  title: "E-Rechnung Guide 2027 — Alles was Sie wissen müssen",
  description: "Komplett-Guide zur E-Rechnungspflicht ab Januar 2027. XRechnung, ZUGFeRD, GoBD-Compliance, DATEV-Integration und wie Sie sich vorbereiten.",
};
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-[#d4d4d4]">
      ...
      <article className="max-w-3xl mx-auto px-6 py-16">
        <div className="mb-12">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-white leading-tight mb-4" style={{fontFamily:"'Instrument Serif',serif"}}>E-Rechnungspflicht 2027:<br/>Der komplette Guide</h1>
          <p className="text-lg text-[#a3a3a3] leading-relaxed">Ab Januar 2027 wird die E-Rechnung für alle B2B-Unternehmen in Deutschland Pflicht. Was bedeutet das für Ihr Unternehmen und wie bereiten Sie sich vor?</p>
        </div>
        ...
        <div className="space-y-12 text-[15px] leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-4">Ab Januar 2027 müssen alle Unternehmen in Deutschland, die B2B-Geschäfte tätigen, E-Rechnungen empfangen und verarbeiten können. Das betrifft Einzelunternehmer genauso wie den Mittelstand und Großkonzerne. Die Empfangspflicht gilt bereits — die Sendepflicht folgt gestaffelt.</p>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              {[
                {date:"Jetzt",title:"Freiwillige Phase",desc:"Unternehmen können bereits freiwillig E-Rechnungen versenden und empfangen."},
                {date:"Jan 2027",title:"Empfangspflicht",desc:"Alle B2B-Unternehmen müssen E-Rechnungen empfangen und verarbeiten können."},
                {date:"2028+",title:"Sendepflicht",desc:"Gestaffelte Einführung der Sendepflicht je nach Unternehmensgröße."},
              ].map((s,i)=>(
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4" style={{fontFamily:"'Instrument Serif',serif"}}>GoBD-Compliance</h2>
            ...
            <p>BelegFlow AI erfüllt diese Anforderungen durch SHA-256 Hash-Chain-Archivierung, vollständige Audit-Trails und KoSIT-Validierung aller eingehenden E-Rechnungen.</p>
          </section>
          ...
          <section>
            ...
            <div className="space-y-3">
              {[
                ...
                {n:"2",t:"Software evaluieren",d:"Wählen Sie eine Lösung, die XRechnung und ZUGFeRD unterstützt, GoBD-konform archiviert und DATEV-Export bietet."},
